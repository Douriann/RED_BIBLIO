...
public class ControladorBiblioteca implements ActionListener{
    ...
    public ControladorBiblioteca(Biblioteca mod, CrudBiblioteca modCrud, Vista_gestionBiblioteca vis)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource() == vis.btnRegistrarBiblio) //HICIERON CLICK AL BOTON REGISTRAR
        {
            ...
            if(modCrud.registrar(mod)) //EL METODO REGISTRAR RETORNA TRUE, POR LO TANTO INSERTO EL REGISTRO
            {
        ...
        if(e.getSource() == vis.btnModificarBiblio) //HICIERON CLICK AL BOTON MODIFICAR
        {
            ...
            if(modCrud.modificar(mod)) //EL METODO MODIFICAR RETORNA TRUE, POR LO TANTO SE MODIFICO EL REGISTRO
            {
        ...
        if(e.getSource() == vis.btnEliminarBiblio) //HICIERON CLICK AL BOTON ELIMINAR
        {
            ...
            if(modCrud.eliminar(mod)) //EL METODO ELIMINAR RETORNA TRUE, POR LO TANTO SE ELIMINO EL REGISTRO
            {
        ...
        if(e.getSource() == vis.btnBuscarBiblio) //HICIERON CLICK AL BOTON BUSCAR
        {
            ...
            if(modCrud.buscar(mod)) //EL METODO BUSCAR RETORNA TRUE, POR LO TANTO SE ENCONTRO UN REGISTRO
            {
            /* No se hace esto
